...
{   
            ...
            <Pressable
              ...
              onPress={
                ...
                {   
                  ...
                  setModalVisible(!modalVisible);
                  console.log("Voici le status de la machine",item.Status);
   ...
   * IF CONDITION
   * let Arr = []
  Arr=data.findAllMachine.map((item)=>item.Status)
  for (let i=0;i<data.findAllMachine.length;i++)
  {
    console.log("boucle for IN");
    
  if (Arr[i] == true)
    {
      console.log("boucle if IN");
      console.log("value compteur",i);
      console.log("data compteur =====>",Arr[i]);
    }
  }
   */
  ...
  //const [Status, SetStatus] = useState() //Supprimer Machine  
  //data2({variables:{CreateMachineInput:{Status: Status},},})